public class RandomNumbers {
    public static void main( String[] args ) {
        ...
        rps = Math.random();
        if (rps < 0.3333333 ) { //will be true 1/3 of the tim3
        ...
        // pick a single random interger, 1-100
        ...
        // pick four random intergers, each 0-99
        ...
        // pick four random intergers, each 10-20
        ...
        System.out.println( "Study Drill Three Random:\t" + a + "\t" + b + "\t" + c );

        a = 5 + (int)(6*Math.random() );
        b = 5 + (int)(6*Math.random() );
        c = 5 + (int)(6*Math.random() );
        System.out.println( "Study Drill Random numbers 5-10:\t" + a + "\t" + b + "\t" + c ); 
    }
}
